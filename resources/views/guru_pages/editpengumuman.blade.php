       ...
       <div class="material-box2">
         <h4 style="text-align: center;">Edit Pengumuman</h4><br>
          <div class="mb-3">
            ...
            <input class="form-control" type="text" placeholder="Bahan UTS dan Tugas Tambahan" aria-label="default input example">
          </div>
          <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Detail pengumuman</label>
            <textarea class="form-control" type="text" placeholder="Materi UTS dari bab 1 - 7. Silakan mengerjakan tgs tambahan, sy tunggu sampai nanti malam." aria-label="default input example"></textarea>
          </div>
