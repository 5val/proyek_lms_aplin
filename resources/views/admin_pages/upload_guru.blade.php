...
@section('admin_content')
    <div>
        <a href="/admin/listguru" class="btn btn-danger">
            Back
        </a>
        <h1>Import Guru Excel Data</h1>
        ...
        <div class="container mt-4">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('uploadGuru.excel') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        document.getElementById('download-template').addEventListener('click', function () {
            ...
            fetch('/admin/downloadTempGuru')
                ...
                .then(blob => {
                    ...
                    a.href = url;
                    a.download = 'template_guru.xlsx'; //  filename
