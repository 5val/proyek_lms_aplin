...
@section('admin_content')
  ...
  <button class="btn btn-danger"><a style="text-decoration: none; color: white;"
    href="/admin/listguru">Back</a></button><br><br>
  <div class="material-box">
    ...
    <div class="mb-3">
      ...
      aria-label="default input example" value="{{ $guru->EMAIL_GURU }}" required>
    </div>
    <div class="mb-3">
      ...
      aria-label="default input example" value="{{ $guru->ALAMAT_GURU }}" required>
    </div>
    <div class="mb-3">
      <label for="exampleFormControlTextarea1" class="form-label">Nomor telepon</label>
      <input class="form-control" type="text" name="telp" placeholder="081234567891" aria-label="default input example"
      value="{{ $guru->NO_TELPON_GURU }}" required>
    </div>
    <div class="mb-3">
