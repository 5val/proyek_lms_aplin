<nav id="sidebarGuru" class="col-3 sidebar p-3">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->is('guru/walikelas') ? 'active' : '' }}" href="/guru/walikelas">Wali
                Kelas</a>
        </li>
        <li class="nav-item">
                ...
                <ul class="nav flex-column ms-3">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('guru/hlm_laporan_tugas') ? 'active' : '' }}"
                            href="/guru/hlm_laporan_tugas">Laporan Nilai Tugas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('guru/hlm_laporan_ujian') ? 'active' : '' }}"
                            href="/guru/hlm_laporan_ujian">Laporan Nilai Ujian</a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ request()->is('guru/hlm_jadwal') ? 'active' : '' }}"
                href="/guru/hlm_jadwal">Jadwal</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/" style="background-color: red; color: white;">Sign out</a>
        </li>
    </ul>
</nav>