<nav class="col-md-2 d-none d-md-block sidebar p-3">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#submenuLaporan" role="button" aria-expanded="{{ request()->is('guru/hlm_laporan_*') ? 'true' : 'false' }}" aria-controls="submenuLaporan">
